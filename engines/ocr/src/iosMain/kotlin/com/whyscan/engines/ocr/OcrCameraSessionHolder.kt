...
/**
 * Punto de encuentro entre el motor y su preview, igual que los de `:engines:vision-ios` y
 * `:engines:zxing-cpp`.
 *
 * Es la tercera copia de las mismas ochenta líneas, y sigue siendo a sabiendas: factorizarlas
 * crearía una dependencia entre motores que deben poder eliminarse por separado (RNF-06, RNF-07),
 * y "quitar un motor" pasaría de borrar una línea de `settings.gradle.kts` a un refactor. El sitio
 * donde vivirían sin acoplar nada es `:core:scanner-ui`, y llevar allí un puente con AVFoundation
 * metería AVFoundation en un módulo que hoy compila para las cuatro plataformas.
 */
@OptIn(ExperimentalForeignApi::class)
internal class OcrCameraSessionHolder {
