...
| `targetSdk` 37 (requisito de Play)               | ✅ con el atrás adaptado al *predictive back*                                                                                                                                                                                                                                                                                                  |
...
| Política de privacidad y términos de uso         | ✅ escritos, comprobables contra el código y enlazados desde Ajustes → Acerca de, en los dos idiomas ([dominio Faro](https://faro.net.ar/whyscan-privacidad)) |
