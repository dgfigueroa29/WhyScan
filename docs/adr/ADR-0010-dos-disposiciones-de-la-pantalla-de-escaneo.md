...
una lista desplazable desaparece en cuanto llega el segundo resultado y la lista crece. Es el
momento
...
tiene su comparador, sus métricas y su ADR-0008. Tirarlo para hacer sitio a un lector convertiría
dos
años de arquitectura de motores en código muerto.

## Decisión

La app tiene **dos modos**, gobernados por una preferencia persistida (
`AppPreferences.advancedMode`,
...
Un solo layout con condicionales tiene que elegir una de las dos jerarquías y disfrazarla de la
otra.
...
- Dos disposiciones que mantener. Se acota compartiendo los componentes y dejando en cada layout
  solo
  el orden y la jerarquía.
- La lista de destinos **cambia en caliente** al apagar el modo avanzado, y el comparador puede
  estar
